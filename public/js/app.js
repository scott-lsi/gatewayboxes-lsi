...
$(document).ready(function () {
    ...
    enquire.register("screen and (min-width:975px)", function () {
        ...
        $('#product-main-image img').wrap('<span class="img-zoom-wrapper" style="position: absolute; overflow: hidden;" />').css('display', 'block').parent().zoom();
    });
...
enquire.register("screen and (max-width:974px)", function () {
    $('#product-main-image img').wrap('<div class="img-zoom-wrapper" />').css('display', 'block');
});
